<?php
  ...
  <?
	...
	"<div id=\"box_image\" class=\"box_image\">" .
        ...
        "<img alt=\"\" src=\"\" id=\"full\" class=\"full_image\" onclick=\"cycleImg(1)\" ontouchstart=\"touchStart(event,'swipeBox');\" ontouchend=\"touchEnd(event);\" ontouchmove=\"touchMove(event);\" ontouchcancel=\"touchCancel(event);\">" .
			"</td></tr>" .
		"</table>" .
	"</div>" .
  ...
  ?> 
  <div id="box_overlay" class="box_overlay" ontouchstart="touchStart(event,'swipeBox');" ontouchend="touchEnd(event);" ontouchmove="touchMove(event);" ontouchcancel="touchCancel(event);"> 
  </body></html>